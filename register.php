...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="اسم المستخدم" class="box"><br><br>
      ...
      <p>هل لديك حساب؟ <a href="https://github.com/kardosea/portfoii/blob/main/index1.php"> تسجيل دخول</a></p>
</center>
   </form>
