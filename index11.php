...
if(isset($_GET['remove'])){
   ...
   mysqli_query($cn, "DELETE FROM cart WHERE id = '$remove_id'") or die('query failed');
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="index1.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('إزالة العنصر من سلة التسوق؟');">حذف</a></td>
         </tr>
      <?php
      ...
      <tr class="table-bottom">
         ...
         <td><a href="index1.php?delete_all" onclick="return confirm('حذف كل المنتجات من العربة?');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">حذف الكل</a></td>
      </tr>
   </tbody>
   </table>
